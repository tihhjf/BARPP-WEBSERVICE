...
import br.com.qwerty.service.CheckoutService;
...
public class CheckoutResource {
	...
	public List<Checkout> buscarTodos() {
		return checkoutService.buscarTodos(); 
	}
	
	@GET
	@Path("/buscar/{id}")
	public Checkout buscar(@PathParam("id") int id) {
		return checkoutService.buscar(id); 
	}
	
	@POST
	@Path("/salvar")
	public Response salvar(Checkout checkout){
		try{
	...
	@PUT
	@Path("/atualizar")
	public Response atualizar(Checkout checkout){
		try{
